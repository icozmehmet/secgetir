...
public class DrinksActivity extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        LinearLayout cont=findViewById(R.id.tuutucu);
        String baseURL = "http://secgetir.live";
        Button gr=findViewById(R.id.ger);
       ...
       Responsable response = resultStr -> {
            try {
                ...
                for (int i = 0;i<result.length();i++) {
                    ...
                    if (!kategori.equals("İçecek"))//Kategori kontrolü
                        continue;
                    ...
                    button.setOnClickListener(view -> {
                        Intent bk=new Intent(DrinksActivity.this, DetailAcivity.class);
        ...
        gr.setOnClickListener(view -> {
            Intent gri=new Intent(DrinksActivity.this, CategoryyActivity.class);
            startActivity(gri);
        });
