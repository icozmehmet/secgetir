...
public class FoodActivity extends AppCompatActivity{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        LinearLayout cont=findViewById(R.id.tutann);
        String baseURL = "http://secgetir.live";
        Button gr=findViewById(R.id.geri);
        Responsable response = resultStr -> {
            try {
                //Çoklu veri gelirse, dizi olarak almak için
                ...
                for (int i = 0;i<result.length();i++) {
                    ...
                    if(!kategori.equals("Yiyecek"))//Kategori kontrolü
                        continue;
                    ...
                    button.setOnClickListener(view -> {
                        Intent bk=new Intent(FoodActivity.this, DetailAcivity.class);
        ...
        gr.setOnClickListener(view -> {
            Intent gri=new Intent(FoodActivity.this, CategoryyActivity.class);
            startActivity(gri);
        });
    }
